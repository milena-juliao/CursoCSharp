...
using System.Linq;
using static CursoCSharpUdemy.TopicosAvancados.LINQ1;
...
namespace CursoCSharpUdemy.TopicosAvancados
{
    internal class LINQ2
    {
        public static void Executar()
        {
            ...
            var mediaDaTurmaAprovados = alunos.Where(aluno => aluno.Nota >= 7).Average(aluno => aluno.Nota);
